...
class EAkta {
  ...
  constructor (es3) {
    ...
    try {
      ...
      signature = dossier['ds:Signature'] ? dossier['ds:Signature'][0] : null
      documentList = dossier['es:Documents']
      metaData = dossierProfile['es:Metadata'] ? dossierProfile['es:Metadata'][0]['mireg:metadata'][0]['mireg:mireg'][0] : null
    } catch (err) {
